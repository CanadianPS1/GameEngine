...
namespace engine{
    EngineSwapChain::EngineSwapChain(EngineDevice &deviceRef, VkExtent2D extent) : device{deviceRef}, windowExtent{extent}{init();}
    EngineSwapChain::EngineSwapChain(EngineDevice &deviceRef, VkExtent2D extent, std::shared_ptr<EngineSwapChain> previous) : device{deviceRef}, 
